...
<section>
	<div class='container-fluid'>
		<div class='row' id="contents">
			...
			<div class='col-md-10 text-center' id='section'>
				<!-- 레이스 나누는 라디오 버튼 부분 -->
				<div class="row" id="post-radio">
				<%if(race_code==null||race_code.equals("A")) {%>
                     <div class="col-md-3">
                          <label class="free-text-head-select"><span>전체 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="A" checked onclick="fn_checked();"></label>
                      </div>
                         <div class="col-md-3">
                            <label class="free-text-head-select"><span>강아지 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="D" onclick="fn_checked();"></label>
                         </div>
                         <div class="col-md-3">
                            <label class="free-text-head-select"><span>고양이 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="C" onclick="fn_checked();"></label>
                         </div>
                         <div class="col-md-3">
                            <label class="free-text-head-select"><span>기타 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="E" onclick="fn_checked();"></label>
                         </div>
                  <%} else if(race_code.equals("D")){%>
                     <div class="col-md-3">
                          <label class="free-text-head-select"><span>전체 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="A" onclick="fn_checked();"></label>
                      </div>
                         <div class="col-md-3">
                            <label class="free-text-head-select"><span>강아지 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="D" checked onclick="fn_checked();"></label>
                         </div>
                         <div class="col-md-3">
                            <label class="free-text-head-select"><span>고양이 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="C" onclick="fn_checked();"></label>
                         </div>
                  ...
                  <%} else if(race_code.equals("C")){%>
                     <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <label class="free-text-head-select"><span>고양이 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="C" checked onclick="fn_checked();"></label>
                         </div>
                         <div class="col-md-3">
                            <label class="free-text-head-select"><span>기타 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="E" onclick="fn_checked();"></label>
                         </div>
                  <%} else if(race_code.equals("E")){%>
                     <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <label class="free-text-head-select"><span>기타 </span><input type="radio" name="free-write-race" class="free-text-head-radio mt-1 ml-1" value="E" checked onclick="fn_checked();"></label>
                         </div>
                  <%} %>
                   </div>
				<script>
                  ...
                  <div id="search-container">
                     ...
                     <div id="search-freePostTitle">
                        <form class="form-inline" action="<%=request.getContextPath()%>/board/freePostFinder">
                           ...
                           <input class="form-control" type="text" name="searchKeyword" size="25"
